            ...
            <li class="main-product">
                    ...
                    <div class="content-product">
                        ...
                        <div class="content-product-deltals">
                            <div class="price">
                                <span class="money">${productArray[i].Price} đ</span>
                            </div>
  ...
  for(let i = 0 ; i< cartArray.length; i++)
  {
      ...
      productRender +=
       ...
       <tr style="text-align: center;vertical-align: center;">
           ...
           <td> <img style = "width: 4rem; height: 4rem;" src="./image/${cartArray[i].Image}" alt=""></td>
           <td>${cartArray[i].Name}</td>
           <td >${cartArray[i].Price} đ</td>
           <td id="quantity-${cartArray[i].Id}">${1}</td>
           <td >${parseInt(cartArray[i].Price)*1} đ</td>            
      ` 
  }
