...
.then(data => {
   pushDataIntoSessionStorage(data);
});

function pushDataIntoSessionStorage(data)
{
...
{
    let dataArray = sessionStorage.getItem("productData");
            ...
            <div class="card h-100">
              ...
              <div class="card-body p-4">
                <div class="text-center">
                  <!-- Product name-->
                  <h5 class="fw-bolder">${getProductType(product.Type)}</h5>
